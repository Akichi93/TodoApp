...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .addTag('Auth', 'Endpoints pour l\'authentification (inscription, connexion, refresh token)')
    .addTag('Profile', 'Endpoints pour la gestion du profil utilisateur (GET /users/me, PATCH /users/me)')
    .addTag('Users', 'Endpoints pour la gestion des utilisateurs (CRUD)')
    .addTag('Tasks', 'Endpoints pour la gestion des tâches (CRUD, filtres, pagination)')
  ...
  // No RabbitMQ microservice by default
